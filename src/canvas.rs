...
impl Canvas2D {
    ...
    pub fn _mouse_position_ex(&self, target_width: f32, target_height: f32) -> (f32, f32) {
    ...
    #[inline]
    #[allow(clippy::missing_panics_doc)]
    pub fn _get_texture_mut(&mut self) -> &mut Texture2D {
    ...
    pub fn _get_padding(&self, target_width: f32, target_height: f32) -> (f32, f32) {
